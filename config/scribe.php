...
return [
    ...
    'title' => 'SkinLookBD API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'REST API for the SkinLookBD skincare storefront, admin dashboard, and mobile clients.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token via <code>POST /api/v1/auth/login</code> or <code>/register</code>, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
    ...
    'strategies' => [
        ...
        'responses' => configureStrategy(
            ...
            Strategies\Responses\ResponseCalls::withSettings(
                // Scoped to public, side-effect-free GET endpoints only. Authenticated/admin endpoints
                // are documented from their FormRequest rules instead of live response calls, since
                // exercising them would require seeding a real Sanctum token before every doc build.
                only: [
                    'GET /api/v1/products',
                    'GET /api/v1/products/*',
